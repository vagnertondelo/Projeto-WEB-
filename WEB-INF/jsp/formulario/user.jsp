                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            ...
                            <div class="content">
                                <form  action='<c:url value="formulario"/>' method="get">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Nome:</label>
                                                <input type="text" name="usuario.nome" class="form-control border-input" placeholder="Nome" value="${usuario.nome}" >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Senha:</label>
                                                <input type="password" name="usuario.senha" class="form-control border-input" placeholder="Senha" value="${usuario.senha}" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Email:</label>
                                                <input type="email" name="usuario.email" class="form-control border-input" placeholder="Email" value="${usuario.email}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-info btn-fill btn-wd">Salvar Perfil</button>
